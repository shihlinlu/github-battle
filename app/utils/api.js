...
// optional client ID and secret ID
// todo: add params to axios calls if using params
...
// return a new array and first player in the array has the highest score
...
module.exports = {
    // returns a promise; and when it is resolved, all players information is displayed
